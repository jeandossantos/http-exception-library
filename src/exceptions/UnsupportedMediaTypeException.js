...
/**
 * Represents an UnsupportedMediaTypeException, which is an HTTP exception indicating that the requested media type is not supported.
 * Extends the HttpException class.
 */
export default class UnsupportedMediaTypeException extends HttpException {
  /**
   * Creates a new instance of UnsupportedMediaTypeException.
